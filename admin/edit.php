                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <input
                          ...
                          placeholder="Judul Artikel" value="<?= $data ['judul_artikel']; ?>" required
                        />
                      </div>
                      <div class="mb-3">
                        ...
                        />
                        <small class="text-danger">Max Size 5Mb, ext. png, jpe, jpeg</small>
                      </div>
                      <div class="mb-3">
                        ...
                        <?php
                          ...
                          echo '<i class="text-danger">File Not Found</i>';
                        }
                        ?>
                      </div>
                                </div>
