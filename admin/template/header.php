          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
               ...
               Halaman Admin e-Mading JeWePe <a href="../index.php" target="_blank" class="ms-3 btn btn-sm btn-icon btn-outline-primary">
                <span class="tf-icon bx bx-link-external"><span>
</a>
                </div>
              </div>
              <!-- /Search -->
